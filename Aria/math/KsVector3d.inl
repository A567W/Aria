 ...
 */
/************************************************************************************************/
ksINLINE KsReal& KsVector3d::operator [] ( KsInt32 index )
{
 ...
 */
/************************************************************************************************/
ksINLINE const KsReal& KsVector3d::operator [] ( KsInt32 index ) const
{
	return( ( (KsReal*)&x )[ index ] );
}
/************************************************************************************************/
// = 演算子 (代入)
/************************************************************************************************/
ksINLINE const KsVector3d& KsVector3d::operator = ( const KsVector3d &refVector )
{
	x = refVector.x;
	y = refVector.y;
	z = refVector.z;
...
// += 演算子
/************************************************************************************************/
ksINLINE KsVector3d& KsVector3d::operator += ( const KsVector3d& refVector )
{
	x += refVector.x;
	y += refVector.y;
	z += refVector.z;
...
//  *= 演算子
/************************************************************************************************/
ksINLINE KsVector3d& KsVector3d::operator *= ( KsReal s )
{
	x *= s;
	y *= s;
	z *= s;
...
// + 演算子(加算)
/************************************************************************************************/
ksINLINE KsVector3d KsVector3d::operator + () const 
{
	return ( *this );
}
...
// + 演算子(加算)
/************************************************************************************************/
ksINLINE KsVector3d KsVector3d::operator + ( const KsVector3d& refVector ) const 
{
...
// * 演算子(掛算) 
/************************************************************************************************/
ksINLINE KsVector3d KsVector3d::operator * ( KsReal s ) const 
{
...
// == 演算子(比較)
/************************************************************************************************/
ksINLINE KsBool KsVector3d::operator == ( const KsVector3d& refVector ) const 
{
...
// 値をセットする
/************************************************************************************************/
ksINLINE void KsVector3d::set( KsReal xf, KsReal yf, KsReal zf )
{
	x = xf;
	y = yf;
	z = zf;
...
// 値をセットする
/************************************************************************************************/
ksINLINE void KsVector3d::set( const KsReal* fArray )
{
	x = fArray[ 0 ];
	y = fArray[ 1 ];
	z = fArray[ 2 ];
...
//　指定された長さのベクトルに変更する
/************************************************************************************************/
ksINLINE void KsVector3d::scaleTo( KsReal len )
{
...
// 0.0fでリセットする
/************************************************************************************************/
ksINLINE void KsVector3d::reset()
{
	x = y = z = 0.0f;
}
...
// 長さを求める
/************************************************************************************************/
ksINLINE KsReal KsVector3d::length()
{
...
// 長さの2乗を求める
/************************************************************************************************/
ksINLINE KsReal KsVector3d::length2()
{
	return ( x*x + y*y + z*z );
}
...
// 正規化
/************************************************************************************************/
ksINLINE void KsVector3d::normalize()
{
...
// 内積
/************************************************************************************************/
ksINLINE KsReal KsVector3d::dotProduct( const KsVector3d& refVector ) const
{
...
// 外積
/************************************************************************************************/
ksINLINE KsVector3d KsVector3d::crossProduct( const KsVector3d& refVector )
{
 ...
 */
/************************************************************************************************/
ksINLINE KsReal KsDotProduct( const KsVector3d& refV0, const KsVector3d& refV1 )
{
 ...
 */
/************************************************************************************************/
ksINLINE KsReal KsDotProduct( const KsVector3d* pV0, const KsVector3d*  pV1 )
{
 ...
 */
/************************************************************************************************/
ksINLINE KsVector3d	KsCrossProduct( const KsVector3d& refVector1, const KsVector3d& refVector2 )
{
 ...
 */
/************************************************************************************************/
ksINLINE void KsCrossProduct( KsVector3d* pOutVector, const KsVector3d*  pV0, const KsVector3d* pV1 )
{
