 ...
 */
/************************************************************************************************/
class ksENGINE_API KsBufferManagerGL : public KsBufferManager
{
	public:
		/**
		 * コンストラクタ
		 ...
		 */
										KsBufferManagerGL( KsRenderSystemGL* pRenderSystem );

		/**
		 * デストラクタ
		 */
		virtual							~KsBufferManagerGL();
